...
public:
	...
	static void resampleToIntensity(float* d_output, unsigned int outputWidth, unsigned int outputHeight, const float4* d_input, unsigned int inputWidth, unsigned int inputHeight);
...
template void CUDAImageUtil::copy<float4>(float4*, float4*, unsigned int, unsigned int);
